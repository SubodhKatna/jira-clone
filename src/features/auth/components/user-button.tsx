...
export const UserButton = () => {
    ...
    if (isLoading) {
        return (
            <div
                className="size-10 rounded-full flex items-center justify-between bg-neutral-200 border border-neutral-300">
        ...
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" side="bottom" sideOffset={10} className="w-60">
                ...
                <DropdownMenuItem
                    disabled={isPending}
                    onClick={() => logout()}
                    className="h-10 flex text-amber-700 items-center justify-center font-medium cursor-pointer">
                    {isPending ? (
